                        ...
                        if (!$USER->IsAuthorized() && $arParams["ALLOW_AUTO_REGISTER"] == "N") {
                                    ...
                                    function validsubmitForm() {
                                        ...
                                        if (name.length < 3) {
                                            ...
                                            if (!pattern.test(name)) {
                                                $('#ORDER_PROP_1').parent().addClass('error');
                                                $('#ORDER_PROP_1').after('<p class="ordering-form__error-text error-text">Вы ввели некорректное имя</p>');
                                                error = 1;
                                            }
                                        }
                            ...
                            if ($_POST["is_ajax_post"] != "Y")
                            {
                                ...
                                <form action="<?= $APPLICATION->GetCurPage(); ?>" method="POST" name="ORDER_FORM"
                                    ...
                                    <p class="ordering-form__ps">Подтверждая заказ вы соглашаетесь с условиями пользования сайтом</p>
                                    <script>
                            ...
                            if ($arParams["DELIVERY_NO_AJAX"] == "N")
                            {
                                ...
                                <div style="display:none;"><?
                                    $APPLICATION->IncludeComponent("bitrix:sale.ajax.delivery.calculator", "", array(), null, array('HIDE_ICONS' => 'Y')); ?></div>
                            <?
                            }
                            }
                            else
